...
Notably, this step is only done for variable selection, and the models can be run with the original, continuous, numeric, features. 
...
That is because the built-in threshold for the SU, 0.25, is too high for this data set. You can use the function 'su_plot' to decide for yourself which threshold is the best
