...
#'
#' @param discretized_exprs A table of features (samples in rows, variables in columns, and each observation in each cell)
#' @param target A target vector, factor containing classes of the observations. Note: the
